...
The data pre-processing steps can be found in the `01_prep.R` file on the [GitHub repository](https://github.com/anshu-uppal/cancer_registry) for this page.
...
age_crude |> 
        ...
        labs(y = "Crude rate per 100,000", x = "Age group", color = NULL)+
        theme_bw()+
...
swiss_ref_XII <- 
        ...
        ungroup() |> 
        right_join(swiss_XII, join_by(id_country, cancer_label, sex, age_ESP))
```
